...
\begin{frame}[fragile]{30-30 Target}
    ...
    From metapopulation theory, should we aim at protecting as many private lands as possible, or should we put our efforts on public lands ?
...
\begin{frame}{What makes a patch unique ?}
    ...
    \begin{itemize}
        \item The quality for colonization
        \item The amount of propagules it produces
        \item It's spatial location 
        \item Local persistence 
    \end{itemize}
...
\begin{frame}{Back to SLOSS}
    ...
    Two phenomenon happens at the same time for a constant total surface : 
